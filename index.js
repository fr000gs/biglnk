...
const links = [
    ...
    { url: 'https://drive.google.com/drive/folders/19oCHiAWF4VIjx-fpIXgKQzXWgfunVUJ_?usp=sharing', text: "Link 0 gfr' },
    { url: 'https://drive.google.com/drive/folders/1QDnGMBc092j5rCwhiecpeAPPAuoOH2RD?usp=drive_link', text: 'Link 1 gsb' },
    { url: 'https://www.dropbox.com/scl/fo/yz5pv99r5h1dbo63re0es/AIH_A400yYNP8Wouu4u1Y_s?rlkey=elrj71vfhfqo2qmi6sy05fwui&st=gyzs9jbv&dl=0', text: 'Link 2 dbo reachmech' },
    { url: 'https://drive.proton.me/urls/G2ZPG3MH74#YzbTVdeInp93', text: 'Link 3 pd bio' },
];
